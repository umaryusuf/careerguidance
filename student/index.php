...
require_once '../connection.php';
  ...
  if(!$_SESSION['student']){
    header("location:".ROOT_URL."/student_login.php");
  }
	...
	<div class="navbar-fixed">
		<nav role="navigation" class="teal ">
			<div class="nav-wrapper">
				<a href="index.php" class="brand-logo center">Student CG</a>
        <ul id="left">
  ...
  <div class="row">
    <aside class=" blue-grey darken-4 hide-on-small-only" id="sidebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li><a href="index.php?action=counsellors"><i class="mdi mdi-settings"></i> Counsellors</a></li>
        <li><a href="index.php?action=test"><i class="mdi mdi-settings"></i> Take a Test</a></li>
    ...
    <main id="main" class="section">
      ...
      ?>
      <div class="row">
        <h2 class="center-align card-panel flow-text" style="font-weight: bold;">Welcome to Student Dashboard Career Guidance</h2>
      ...
      <?php  
        ...
        }else if(isset($_GET['action']) && $_GET['action'] === "counsellors"){
          require_once 'includes/counsellors.php';
        }else if(isset($_GET['action']) && $_GET['action'] === "test_scores"){
          require_once 'includes/test_scores.php';
